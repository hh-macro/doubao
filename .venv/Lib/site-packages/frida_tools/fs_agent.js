...
✄
{"version":3,"file":"add-abort-signal.js","names":["eos","AbortError","errorCodes","ERR_INVALID_ARG_TYPE","addAbortSignal","signal","stream","name","validateAbortSignal","obj","pipe","module","exports","addAbortSignalNoValidate","onAbort","destroy","aborted","addEventListener","removeEventListener"],"sourceRoot":"/home/oleavr/src/frida-tools/build/agents/fs/fs_agent.js.p/node_modules/@frida/readable-stream/lib/","sources":[""],"mappings":"OAAOA,MAAS,0CAEdC,WACSC,MACJ,eAEP,MAAMC,qBAAEA,GAAyBD,SAgB1B,SAASE,eAAeC,EAAQC,GAErC,GAb0B,EAACD,EAAQE,KACnC,GAAsB,iBAAXF,KACJ,YAAaA,GAClB,MAAM,IAAIF,EAAqBI,EAAM,cAAeF,EACtD,EAQAG,CAAoBH,EAAQ,YALRI,EAMFH,IALmB,mBAAbG,EAAIC,KAM1B,MAAM,IAAIP,EAAqB,SAAU,gBAAiBG,GAP9D,IAAsBG,EASpB,OAAOE,OAAOC,QAAQC,yBAAyBR,EAAQC,EACzD,QAEO,SAASO,yBAAyBR,EAAQC,GAC/C,GAAsB,iBAAXD,KAAyB,YAAaA,GAC/C,OAAOC,EAET,MAAMQ,EAAU,KACdR,EAAOS,QAAQ,IAAId,EAAa,EAQlC,OANII,EAAOW,QACTF,KAEAT,EAAOY,iBAAiB,QAASH,GACjCd,EAAIM,GAAQ,IAAMD,EAAOa,oBAAoB,QAASJ,MAEjDR,CACT"}
✄
...
✄
{"version":3,"file":"once.js","names":["once","callback","called","args","Reflect","apply","this"],"sourceRoot":"/home/oleavr/src/frida-tools/build/agents/fs/fs_agent.js.p/node_modules/@frida/readable-stream/lib/","sources":[""],"mappings":"eAqBe,SAASA,EAAKC,GAC3B,IAAIC,GAAS,EACb,OAAO,YAAYC,GACbD,IACJA,GAAS,EACTE,QAAQC,MAAMJ,EAAUK,KAAMH,GAChC,CACF"}
✄
export default function t(t){let e=!1;return function(...n){e||(e=!0,Reflect.apply(t,this,n))}}
✄
{"version":3,"file":"passthrough.js","names":["Transform","Object","setPrototypeOf","PassThrough","prototype","options","this","call","_transform","chunk","encoding","cb"],"sourceRoot":"/home/oleavr/src/frida-tools/build/agents/fs/fs_agent.js.p/node_modules/@frida/readable-stream/lib/","sources":[""],"mappings":"OAyBOA,MAAe,iBACtBC,OAAOC,eAAeC,EAAYC,UAAWJ,EAAUI,WACvDH,OAAOC,eAAeC,EAAaH,kBAEpB,SAASG,EAAYE,GAClC,KAAMC,gBAAgBH,GACpB,OAAO,IAAIA,EAAYE,GAEzBL,EAAUO,KAAKD,KAAMD,EACvB,CAEAF,EAAYC,UAAUI,WAAa,SAASC,EAAOC,EAAUC,GAC3DA,EAAG,KAAMF,EACX"}
✄
...
✄
{"version":3,"file":"promises.js","names":["eos","pl","isIterable","isNodeStream","pipeline","streams","Promise","resolve","reject","signal","lastArg","length","pop","err","value","finished","stream","opts"],"sourceRoot":"/home/oleavr/src/frida-tools/build/agents/fs/fs_agent.js.p/node_modules/@frida/readable-stream/lib/","sources":[""],"mappings":"OAAOA,MAAS,4CACSC,MAAU,qCAEjCC,kBACAC,MACK,oBAEA,SAASC,YAAYC,GAC1B,OAAO,IAAIC,SAAQ,CAACC,EAASC,KAC3B,IAAIC,EACJ,MAAMC,EAAUL,EAAQA,EAAQM,OAAS,GACzC,GAAID,GAA8B,iBAAZA,IACjBP,EAAaO,KAAaR,EAAWQ,GAAU,CAElDD,EADgBJ,EAAQO,MACPH,MACnB,CAEAR,EAAGI,GAAS,CAACQ,EAAKC,KACZD,EACFL,EAAOK,GAEPN,EAAQO,EACV,GACC,CAAEL,UAAS,GAElB,QAEO,SAASM,SAASC,EAAQC,GAC/B,OAAO,IAAIX,SAAQ,CAACC,EAASC,KAC3BR,EAAIgB,EAAQC,GAAOJ,IACbA,EACFL,EAAOK,GAEPN,GACF,GACA,GAEN"}
✄
...
✄
{"version":3,"file":"index.js","names":["isDisturbed","LegacyStream","Readable","Writable","Duplex","Transform","PassThrough","pipeline","addAbortSignal","finished","destroy","compose","promises"],"sourceRoot":"/home/oleavr/src/frida-tools/build/agents/fs/fs_agent.js.p/node_modules/@frida/stream/","sources":[""],"mappings":"sBACEA,kBACAC,cACAC,cACAC,YACAC,eACAC,iBACAC,cACAC,oBACAC,cACAC,aACAC,aACAC,cACAC,MACK,iCAEQX,SAEbD,iBACAC,YACAC,cACAC,cACAC,YACAC,eACAC,iBACAC,cACAC,oBACAC,cACAC,aACAC,aACAC"}
✄
